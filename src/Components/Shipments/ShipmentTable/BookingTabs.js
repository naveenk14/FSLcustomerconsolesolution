            ...
            >
              ...
              {!showText ? (
                <>
                  ...
                  >
                    <Tooltip title="Dashboard View" trigger={"hover"}>
                      <img
                        src={ButtonList}
                  ...
                  >
                    <Tooltip title= "DSR" trigger={"hover"}>
              ...
              {!showText ? (
                ...
                <div className="d-flex align-items-center">
                  <Tooltip title="Auto Scheduler" trigger={"hover"}>
                    <img
                      src={image1}
                      alt="img"
                      className="me-1"
                  ...
                  <Tooltip title="Download DSR"trigger={"hover"}>
                    <img
                      src={image2}
                      alt="img"
                      className="mx-1"
                  ...
                  <Tooltip title="Save Column Settings"trigger={"hover"}>
                    <img
                      src={image3}
                      alt="img"
                      className="ms-1 me-3"
