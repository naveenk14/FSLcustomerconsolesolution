...
const UploadDoc = ({ open, close }) => {
  ...
  return (
    <Dialog open={open} onClose={close} className="uploadDocMdl">
      {/* <div
      ...
      >
        ...
        />
        <div>
          <div className="mt-2" style={{ fontSize: "34px", fontWeight: "700" }}>
            Upload your Document
          </div>
          <div style={{ fontSize: "10px", color: "#384656" }}>
            Kindly select your document type and upload your document to process
            your shipment
          </div>
        </div>
